  ...
  return (
      ...
      <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 md:gap-20 mx-auto mt-16">
          <img className="max-w-28 md:max-w-32" src="/framer.svg" alt="" />
          <img className="max-w-28 md:max-w-32" src="/huawei.svg" alt="" />
          <img className="max-w-28 md:max-w-32" src="/instagram.svg" alt="" />
          <img className="max-w-28 md:max-w-32" src="/microsoft.svg" alt="" />
          <img className="max-w-28 md:max-w-32" src="/walmart.svg" alt="" />
        </div>
      </section>
